...
#basedir = r'D:\Data\MockOR\PigExpts\SERV-CT-ALL'
...
rectified_output_dir = path.join(output_dir, 'Reference_CT_test')
...
zbuffer_dims = zbuffer.GetDimensions()
print("Zbuffer dimensions:", zbuffer_dims)

dims = zbuffer.GetDimensions()  # dims is (x, y, z)
print("ZBuffer dims:", dims)

# Use actual zbuffer dimensions
w_z = zbuffer_dims[0] // 2  # Assuming the render shows left+right images side by side
h_z = zbuffer_dims[1]


x_min = w_z
x_max = zbuffer_dims[0] - 1  # Right half
y_min = 0
y_max = h_z - 1
...
left_depth.SetVOI(x_min, x_max, y_min, y_max, 0, 0)
...
# RIGHT (first half of zbuffer)
right_depth.SetVOI(0, w_z - 1, 0, h_z - 1, 0, 0)

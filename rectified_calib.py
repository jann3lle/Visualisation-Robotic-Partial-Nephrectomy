...
def save_calib_params_json(calib_params, filename, valid_frame_indices):
    ...
    data = {
    'K1': calib_params.left_params.camera_matrix.tolist(),
    'D1': calib_params.left_params.dist_coeffs.tolist(),
    'K2': calib_params.right_params.camera_matrix.tolist(),
    'D2': calib_params.right_params.dist_coeffs.tolist(),
    'R': calib_params.l2r_rmat.tolist(),
    'T': calib_params.l2r_tvec.tolist(),
    'E': calib_params.essential.tolist(),
    'F': calib_params.fundamental.tolist()
    }
